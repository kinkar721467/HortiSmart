...
export const storageFacilities = [
  { name: 'Green Valley Cold Storage', location: 'Sector 12, Noida, Uttar Pradesh • 5 km', rating: 4.8, reviews: 104, capacity: '1000 MT', available: '750 MT', price: '₹25/MT/day', tags: ['Temperature Control', 'Humidity Control', '24/7 Security', '+1 more'], availability: 'High Availability', availColor: 'text-green-600 bg-green-50 border-green-200', phone: '+91 98765 01234', email: 'info@greenvalleycold.in', owner: 'Rajesh Yadav' },
  { name: 'FreshKeep Storage Solutions', location: 'Khanna, Punjab • 12 km', rating: 4.5, reviews: 89, capacity: '1500 MT', available: '200 MT', price: '₹22/MT/day', tags: ['Multi-Chamber', 'Loading Bay', 'Insurance Available', '+1 more'], availability: 'Low Availability', availColor: 'text-red-600 bg-red-50 border-red-200', phone: '+91 94455 67890', email: 'contact@freshkeep.co.in', owner: 'Harpreet Singh' },
  { name: 'Agri-Cool Storage', location: 'Faridabad, Haryana • 15 km', rating: 4.9, reviews: 201, capacity: '800 MT', available: '400 MT', price: '₹30/MT/day', tags: ['Eco-Friendly', 'Quick Unload', 'Pest Control', '+1 more'], availability: 'High Availability', availColor: 'text-green-600 bg-green-50 border-green-200', phone: '+91 91234 56789', email: 'support@agricool.org', owner: 'Amit Sharma' },
  { name: 'Polar Storage Pvt Ltd', location: 'Gurugram, HR • 22 km', rating: 4.7, reviews: 145, capacity: '2000 MT', available: '1000 MT', price: '₹28/MT/day', tags: ['Bulk Storage', 'Cold Chain', 'Transport', '+2 more'], availability: 'Medium Availability', availColor: 'text-orange-600 bg-orange-50 border-orange-200', phone: '+91 88776 65544', email: 'operations@polarstorage.com', owner: 'Vikram Goel' },
  { name: 'Himalaya Cold Chain', location: 'Vashi APMC, Mumbai • 8 km', rating: 4.6, reviews: 312, capacity: '5000 MT', available: '1200 MT', price: '₹35/MT/day', tags: ['Export Ready', '24/7 Access', 'Packaging', '+3 more'], availability: 'Medium Availability', availColor: 'text-orange-600 bg-orange-50 border-orange-200', phone: '+91 99887 76655', email: 'reachus@himalayacold.com', owner: 'Sanjay Patil' },
  { name: 'Kisan Mitra Storages', location: 'Nashik, Maharashtra • 3 km', rating: 4.2, reviews: 56, capacity: '500 MT', available: '450 MT', price: '₹18/MT/day', tags: ['Farmer Cooperative', 'Low Cost', 'Basic Storage'], availability: 'High Availability', availColor: 'text-green-600 bg-green-50 border-green-200', phone: '+91 77665 54433', email: 'kisanmitra@coop.org', owner: 'Ramesh Pawar' },
  { name: 'SafeCrop Godowns', location: 'Indore, MP • 18 km', rating: 4.4, reviews: 78, capacity: '1200 MT', available: '0 MT', price: '₹20/MT/day', tags: ['Grain Storage', 'Ventilated', 'Pest Control'], availability: 'Full', availColor: 'text-red-600 bg-red-50 border-red-200', phone: '+91 88990 01122', email: 'support@safecrop.in', owner: 'Dinesh Patel' },
  { name: 'Apex Freezers', location: 'Kolkata, WB • 10 km', rating: 4.8, reviews: 190, capacity: '3000 MT', available: '800 MT', price: '₹40/MT/day', tags: ['Deep Freeze', 'Perishables', 'Backup Generator'], availability: 'Medium Availability', availColor: 'text-orange-600 bg-orange-50 border-orange-200', phone: '+91 90080 07006', email: 'operations@apexfreezers.co', owner: 'Subhasis Roy' },
];
